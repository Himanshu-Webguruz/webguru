...
const page = () => {
  return (
    <div>
      <section className="thankyou py-5">
        <div className="container">
          <div className="row">
            <div className="col-sm-12 col-xs-12 thankyou-content text-center">
              ...
              <h3>Thank You</h3>
              <p>
                Thank you for reaching out. An email with your appointment
                details is on the way to your inbox. Please check your spam
                folder in case you have trouble seeing it.
              </p>
...
export const metadata = {
  title: "Thank You for Booking an Appointment with WebGuruz",
  description:
    "Thank you for booking your appointment with WebGuruz! We’ve received your request and will confirm your appointment shortly. We look forward to meeting you!",
};