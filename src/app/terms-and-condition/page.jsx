...
export const metadata = {
  ...
  description:
    "Read WebGuruz's Terms and Conditions to understand the guidelines and policies governing the use of our services. Your trust and compliance are important to us.",
};