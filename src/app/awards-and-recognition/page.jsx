...
export const metadata = {
  ...
  description:
    "See how WebGuruz has earned global recognition for its innovation, excellence, and industry leadership. Discover our awards and the impact we've made worldwide.",
};