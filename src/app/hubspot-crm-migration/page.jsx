...
export const metadata = {
  ...
  description:
    "Experience hassle-free HubSpot CRM migration services by WebGuruz. Ensure smooth data transfer, enhanced efficiency, and seamless integration for business growth.",
};