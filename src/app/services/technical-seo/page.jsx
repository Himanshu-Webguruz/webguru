...
const page = () => {
  return (
    <>
      <TechnicalBanner/>
      <TechnicalForm heading={"Boost Your Website’s Potential with Our "}
      subheading={"Technical SEO Services"}
      paragraph={"Ready to take your website’s performance to the next level? Our Technical SEO services are tailored to ensure your site is technically sound, search engine-friendly, and poised for success. We have the expertise and the tools to make that happen."}
      />
      <TechnicalCounter/>
      <TechnicalServices/>
      <TechnicalIndustry/>
