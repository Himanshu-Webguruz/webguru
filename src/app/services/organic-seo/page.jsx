...
export const metadata = {
  ...
  description:"Boost your business with top organic SEO agency in India. Our expert SEO company in Mohali provides organic SEO services. Get results with organic SEO experts.",
};