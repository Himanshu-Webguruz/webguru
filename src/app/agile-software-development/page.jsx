...
export const metadata = {
  ...
  description:
    "Achieve faster results with WebGuruz’s agile software development. Our expert team combines cutting-edge technology, innovative solutions, and fast delivery.",
};