    ...
    >
        ...
        <section className="foundation-one foundation-slider ">
          <div className="container">
            <div className="row slider-content">
              <h1 className="text-white">Education Donations</h1>
              ...
              <div className="slider-btn">
                <a href="#" className="found-slider-btn">
                  Read More
                </a>
              </div>
            </div>
      ...
      <SwiperSlide>
        <section className="foundation-three foundation-slider">
          <div className="container">
            <div className="row slider-content">
              <h1 className="text-white">Covid Vaccination Camp</h1>
              <p className="text-white">
