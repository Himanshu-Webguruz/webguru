      ...
      <section className="customised-content-section hub-services-steps py-5 position-relative">
        <div className="container">
          <div className="title-csutomised text-center heading-main inner-page">
            <h2 className="mb-4">
            Manage your Marketing, Sales, & Customer Service-<br/> <span>All from a Single Platform</span>
            </h2>
            ...
            <div className="col-xs-12 col-md-4 col-lg-4">
              <div className="awareness-inner text-center bottomSlide">
                <div>
                  ...
                  <div className="icon-awareness">
                    <span>
<svg fill="#000000" height="50px" width="50px" version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
            ...
            <div className="col-xs-12 col-md-4  col-lg-4">
              <div className="awareness-inner text-center bottomSlide">
                <div>
                  ...
                  <div className="icon-awareness">
                    <span>
<svg width="50px" height="50px" viewBox="0 0 512 512" id="Layer_1" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
