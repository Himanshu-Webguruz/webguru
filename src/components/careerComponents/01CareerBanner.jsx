            ...
            <div className="image heading-main">
              ...
              <div className="heading-main">
                <div className="carrer-banner">
                  ...
                  <h3 className="banner-heading-one">    <strong className="color-wt">for visionaries and creators.</strong></h3>
                  <p className="mt-4">
                  Consider yourself creative or technologically inclined. If so, we&apos;d love for you to join our team and help us change the way the world sees  technology.
                  </p>
            ...
            <div className="image heading-main">
              ...
              <div className="heading-main">
                <div className="carrer-banner">
                  ...
                  Our Internship Program Parichay</h2>
                  <h3 className="my-4">
                  with your Career
                  </h3>
                  <button className="explore-btn" onClick={handleScrollToJobs}>
