...
const MigrateCertificate = () => {
  return (
    <section id="hubspotacademy" className="hub-migrate-certificate py-5">
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-4 ">
            <h2>
           We are Certified HubSpot Developers & <span>Marketing Specialists</span>
            </h2>
          </div>
        </div>
        <div className="row">
...
export default MigrateCertificate;
