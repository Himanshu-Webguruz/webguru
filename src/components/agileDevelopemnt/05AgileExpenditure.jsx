        ...
        <div className="container">
          ...
          <div className="row mb-4">
            <div className="col-sm-3 col-xs-12 icon-contnt text-center">
              <Image src={process1} alt="Product Backlog" />
              <p>
                <strong>Product Backlog</strong>
              </p>
            </div>
            <div className="col-sm-3 col-xs-12 icon-contnt text-center">
              <Image src={process2} alt="Sprint Backlog" />
              <p>
                <strong>Sprint Backlog</strong>
              </p>
            </div>
            <div className="col-sm-3 col-xs-12 icon-contnt text-center">
              <Image src={process3} alt="Daily Scrum Meeting" />
              <p>
                <strong>Daily Scrum Meeting</strong>
              </p>
            </div>
            <div className="col-sm-3 col-xs-12 icon-contnt text-center">
              <Image src={process4} alt="Potentially Shippable Product Increment" />
              <p>
